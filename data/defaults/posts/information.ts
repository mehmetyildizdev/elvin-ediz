...
export const defaultInformationPosts: PostData[] = [
  {
    ...
    "checklistDescription": "Review these primary parameters before initiating formal filings to ensure full documentation readiness and eliminate common IRCC procedural delays.",
    ...
    "excerpt": "Clarity at the outset prevents costly refusals: timeline expectations, proof-of-funds readiness, and verifiable principal applicant credentials.",
    "iconName": "book-open",
  ...
  },
  {
    ...
    "authorName": "Nazly Sunguroglu",
    "authorRole": "Regulated Canadian Immigration Consultant",
    "checklistDescription": "Systematic strategies to increase your Comprehensive Ranking System (CRS) point totals across human capital, language, and provincial nomination factors.",
    "checklistIcon": "award",
    "checklistItems": [
    ...
    "excerpt": "Learn how strategic language retakes, spouse credentials, and provincial nominee alignments can elevate your profile above competitive draw cut-offs.",
    "iconName": "sparkles",
    ...
    "slug": "complete-guide-to-express-entry-crs-optimization",
  ...
  },
  {
    ...
    "authorName": "Nazly Sunguroglu",
    "authorRole": "Regulated Canadian Immigration Consultant",
    "checklistDescription": "Essential guidelines for securing a Canadian study permit, drafting a persuasive Statement of Purpose, and satisfying visa officer bona fide student criteria.",
    ...
    "excerpt": "A structured guide covering acceptance letters, provincial attestations (PAL), cost-of-living proof, and building a compelling dual-intent narrative.",
    ...
    "slug": "study-permit-document-checklist-and-statement-of-purpose",
  ...
  },
  {
    ...
    "authorName": "Nazly Sunguroglu",
    "authorRole": "Regulated Canadian Immigration Consultant",
    "checklistDescription": "Step-by-step procedures to preserve legal employment authorization, utilize maintained status, and bridge to permanent residence without disruption.",
    ...
    "excerpt": "How to maintain continuous legal authorization to work in Canada while transitioning between employer-specific, open, or bridging work permits.",
    "iconName": "briefcase",
    ...
    "slug": "in-canada-work-permit-transition-guide",
  ...
  },
  {
    ...
    "authorName": "Nazly Sunguroglu",
    "authorRole": "Regulated Canadian Immigration Consultant",
    "checklistDescription": "Comprehensive evidentiary requirements to satisfy IRCC Section 4 bona fide relationship standards for inland and outland spousal sponsorship.",
    ...
    "excerpt": "Detailed guidance on compiling financial, cohabitation, and social evidence to demonstrate a genuine relationship free of immigration convenience concerns.",
    "iconName": "heart",
    ...
    "slug": "spousal-sponsorship-relationship-proof-checklist",
  ...
  },
  {
    ...
    "authorName": "Nazly Sunguroglu",
    "authorRole": "Regulated Canadian Immigration Consultant",
    "checklistDescription": "Detailed statutory checklist to ensure flawless physical presence calculations, tax filing compliance, and test readiness before applying for Canadian citizenship.",
    ...
    "excerpt": "A step-by-step roadmap detailing the 1,095-day rule, temporary resident credit calculations, CRA tax requirements, and study tips for the citizenship exam.",
    "iconName": "landmark",
    ...
    "slug": "canadian-citizenship-application-physical-presence-guide",
