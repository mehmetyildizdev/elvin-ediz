...
export function ServiceDetail({
  ...
  const displaySummary =
    service?.summary || 'Comprehensive Canadian immigration consultation and representation.';
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12">
          <div className="lg:col-span-8">
            ...
            <p className="text-text-muted mb-6 text-base leading-relaxed">
              At Elvin Ediz Immigration Services, every case for {displayTitle} is managed under the
              direct supervision of Nazly Sunguroglu, RCIC. We analyze your qualifications, gather
              verified documentation, and construct a robust application that addresses IRCC
              criteria.
            </p>
            ...
            <ul className="mb-10 space-y-4">
              {features.map((feat, i) => (
                <li
                  key={i}
                  className="border-border-subtle bg-bg-surface flex items-start gap-3 rounded-sm border p-4"
                >
                  ...
                  <div>
                    ...
                    <p className="text-text-muted mt-0.5 text-xs leading-relaxed">
                      Tailored representation and thorough documentation audit according to Canadian
            ...
            <div className="border-border-subtle bg-bg-surface/60 rounded-sm border p-6">
              ...
              <p className="text-text-muted mt-2 text-sm leading-relaxed">
                As a Regulated Canadian Immigration Consultant (RCIC), Nazly Sunguroglu is
                authorized under Canadian federal law to represent your application before
            ...
            <div className="bg-bg-primary text-text-on-dark sticky top-28 flex flex-col gap-6 rounded-sm p-8 shadow-xl">
              <div>
                ...
                <p className="text-text-on-dark-muted mt-2 text-xs leading-relaxed">
                  Connect via WhatsApp for a direct 1-on-1 consultation regarding your eligibility
                  for {displayTitle}.
                </p>
              </div>
              ...
              <div className="border-border-on-dark/20 border-t pt-4 text-xs">
                <p className="text-text-on-dark-muted">
                  ...
                  {settings?.address || 'Toronto, Ontario, Canada'}
                  <br />
                  <strong>Direct Line / WhatsApp:</strong>{' '}
                  {settings?.phone || settings?.whatsappNumber || '123456789'}
                </p>
              </div>
            </div>
          </div>
