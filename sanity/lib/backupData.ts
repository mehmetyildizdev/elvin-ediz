...
export const backupServices: ServiceData[] = [
  {
    ...
    "order": 1,
    "iconName": "passport",
    "summary": "A Visitor Visa (Temporary Resident Visa) is an official document allowing foreign nationals to enter Canada for a short stay (usually up to six months) for tourism, family visits, business engagements, or medical consultations.",
    "features": [
    ...
    "ctaSubtitle": "Connect directly with Nazly Sunguroglu, RCIC for comprehensive application assessment and representation.",
  ...
  },
  {
    ...
    "order": 2,
    "iconName": "suitcase",
    "summary": "Temporary Resident Status allows foreign nationals to stay in Canada legally for a defined period as a visitor, student, or worker, with structured pathways to transition to permanent residency.",
    "features": [
    ...
    "ctaSubtitle": "Consult directly with Nazly Sunguroglu, RCIC to assess study permits, work permits, or status extensions.",
  ...
  },
  {
    ...
    "order": 3,
    "iconName": "home",
    "summary": "Permanent Residency (PR) confers the right to live, work, and study anywhere in Canada on a long-term basis with full access to healthcare and social benefits, serving as the direct gateway to Canadian citizenship.",
    "features": [
  ...
  },
  {
    ...
    "order": 4,
    "iconName": "briefcase",
    "summary": "Canada’s Start-Up Visa Program is designed for innovative entrepreneurs who want to establish a high-growth business in Canada and secure direct permanent residency for themselves and their families.",
    "features": [
    ...
    "ctaSubtitle": "Connect with Nazly Sunguroglu, RCIC for comprehensive Start-Up Visa business review and application preparation.",
  ...
  },
  {
    ...
    "summary": "A Labour Market Impact Assessment (LMIA) issued by ESDC allows Canadian employers to hire foreign workers when no Canadian citizen or permanent resident is available, confirming a positive or neutral impact on the Canadian labor market.",
    "features": [
    ...
    "ctaSubtitle": "Guiding Canadian businesses through Job Bank recruitment, ESDC submissions, and foreign worker work permits.",
...
export const backupGoogleReviews: GoogleReviewsData = {
  ...
  rating: 4.9,
  totalReviews: 73,
  googleMapsUrl: 'https://www.google.com/maps/place/Elvin+Ediz+Immigration+Services/@43.846367,-79.383731,17z/data=!4m6!3m5!1s0x42609be984f53c27:0x8157fbe4a4cd3191!8m2!3d43.846367!4d-79.383731!16s%2Fg%2F11qb5x2mcv',
  ...
  reviews: [
    {
      ...
      rating: 5,
      date: 'Recent',
      quote: 'Exceptional service and clear guidance throughout the entire immigration process. Nazly was extremely supportive and professional.',
      highlight: true,
    },
    {
      author: 'Snyldz Yldz',
      rating: 5,
      date: 'Recent',
      quote: 'Great experience with Elvin Ediz Immigration Services. Every question was answered promptly with honest, clear guidance.',
      highlight: true,
    },
    {
      ...
      rating: 5,
      date: 'Recent',
      quote: 'Professional, trustworthy, and very knowledgeable. Nazly handled our case with utmost dedication.',
      highlight: true,
    },
    {
      author: 'Ertan Sokmen',
      rating: 5,
      date: 'Recent',
      quote: 'I am extremely impressed with the professionalism and expertise Ms. Nazly brought to my case. Once she took over, everything moved smoothly.',
      highlight: true,
    },
    {
      author: 'Sarah D.',
      rating: 5,
      date: 'Recent',
      quote: 'We applied for my mother. Everything was very easy and our visa was approved. Guidance was provided accurately on time.',
      highlight: true,
    },
  ],
};
