...
import { formatDate, getLocalizedPostHref } from '@/components/pages/insights/utils';
...
export async function Insights({
  ...
  const fetchedPosts = await fetchPosts('insight', lang);
  const displayPosts =
  ...
  const viewAllHref = homeData.insightsViewAllLink
    ? localize(homeData.insightsViewAllLink)
    : localize('/insights');
