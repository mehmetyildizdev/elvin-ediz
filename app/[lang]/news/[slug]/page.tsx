...
export async function generateStaticParams() {
  return await fetchAllPostSlugsWithLang('news');
}
...
export async function generateMetadata({
  ...
  const canonicalPath =
    currentLang === defaultLanguage ? `/news/${post.slug}` : `/${currentLang}/news/${post.slug}`;
