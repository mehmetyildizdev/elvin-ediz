...
export const ICON_LIBRARY: IconDefinition[] = [
  ...
  {
    name: 'suitcase',
    label: 'Business Immigrant / Start-up',
    category: 'Business',
  ...
  { name: 'user', label: 'Single Applicant Profile', category: 'People', icon: User },
  {
    ...
    label: 'Compassionate Assessment',
    category: 'People',
    icon: HeartHandshake,
  },
  ...
  {
    name: 'messages',
    label: 'Multi-Channel Discussion',
    category: 'Contact',
    icon: MessagesSquare,
  },
  ...
  {
    name: 'sparkles',
    label: 'Premium Full-Service Representation',
    category: 'Contact',
    icon: Sparkles,
  },
