...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return buildPageMetadata({
    pageTitle: `${faqPageData.titleMain || 'Frequently Asked Questions'} ${faqPageData.titleAccent || '& Immigration Q&A'}`.trim(),
    pageDescription: faqPageData.description || 'Common questions and answers regarding Canadian immigration visas, Express Entry, study permits, and work permits.',
    seo: faqPageData.seo,
    settings,
...
export default async function QuestionsPage() {
  ...
  const faqJsonLd = buildPageJsonLd({
    title: `${faqPageData.titleMain || 'Frequently Asked Questions'} ${faqPageData.titleAccent || '& Immigration Q&A'}`.trim(),
